...
class ResendTicketWhatsappActionTest extends TestCase
{
    ...
    public function test_it_requeues_the_ticket_as_a_document_inside_the_24h_window(): void
    {
        ...
        $purchase = $purchase->fresh(['ticket', 'numbers', 'customer', 'conversationStates']);
        $ticket = $purchase?->ticket;

        $this->assertNotNull($ticket, 'Expected a ticket to have been generated by ApprovePaymentAction via PostPaymentApprovedJob.');
